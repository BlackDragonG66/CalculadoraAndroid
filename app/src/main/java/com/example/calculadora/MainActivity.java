...
public class MainActivity extends AppCompatActivity {
    ...
    private String operator = "",primernumero,segundonumero;
    ...
    void suma (){
        //adquirimos el primer numero
        numero1 = parseDouble(resultTextView.getText().toString());
        numero2 = parseDouble(resultTextView.getText().toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        operationEditText = findViewById(R.id.Operation);
